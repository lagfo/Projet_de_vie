...
val skills = listOf(
    ...
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_calcul_mathematique), strokeColor = R.color.primary_color, paint = R.drawable.calculs),
    ...
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_comptabilite), strokeColor = R.color.primary_color, paint = R.drawable.comptabilite),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_cordonnerie), strokeColor = R.color.primary_color, paint = R.drawable.cordonnerie),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_couture), strokeColor = R.color.primary_color, paint = R.drawable.couture),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_cuisine), strokeColor = R.color.primary_color, paint = R.drawable.cuisine),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_ecriture), strokeColor = R.color.primary_color, paint = R.drawable.ecriture),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_electricite), strokeColor = R.color.primary_color, paint = R.drawable.electricite),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_elevage), strokeColor = R.color.primary_color, paint = R.drawable.elevage),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_enseignement), strokeColor = R.color.primary_color, paint = R.drawable.enseignement),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_fabrication_savon), strokeColor = R.color.primary_color, paint = R.drawable.fabrication_savon),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_force_ordre), strokeColor = R.color.primary_color, paint = R.drawable.force_ordre),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_froid), strokeColor = R.color.primary_color, paint = R.drawable.frigoriste),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_infirmerie_aidesoignant), strokeColor = R.color.primary_color, paint = R.drawable.infirmerie_aidesoignant),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_infographie), strokeColor = R.color.primary_color, paint = R.drawable.infographie),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_informatique), strokeColor = R.color.primary_color, paint = R.drawable.informatique),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_langues_etrangeres), strokeColor = R.color.primary_color, paint = R.drawable.langues_etrangeres),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_litterature_histoire), strokeColor = R.color.primary_color, paint = R.drawable.litterature_histoire),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_menage), strokeColor = R.color.primary_color, paint = R.drawable.menage),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_maconnerie), strokeColor = R.color.primary_color, paint = R.drawable.maconnerie),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_maraichage), strokeColor = R.color.primary_color, paint = R.drawable.maraichage),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_marketing), strokeColor = R.color.primary_color, paint = R.drawable.marketing),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_mecanique), strokeColor = R.color.primary_color, paint = R.drawable.mecanique),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_menuiserie_ebenisterie_charpenterie), strokeColor = R.color.primary_color, paint = R.drawable.menuiserie_ebenisterie_charpenterie),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_musique_dance), strokeColor = R.color.primary_color, paint = R.drawable.musique_dance),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_peche), strokeColor = R.color.primary_color, paint = R.drawable.peche),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_pisciculture), strokeColor = R.color.primary_color, paint = R.drawable.pisciculture),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_plomberie), strokeColor = R.color.primary_color, paint = R.drawable.plomberie),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_restauration), strokeColor = R.color.primary_color, paint = R.drawable.restauration),
    AppSkillCardIcon(txt = Txt.Res(R.string.skill_secretariat), strokeColor = R.color.primary_color, paint = R.drawable.secretariat),
