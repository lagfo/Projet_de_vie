...
fun MonReseauCategoriesScreen(navController:NavController,onNavigate: () -> Unit) {
    ...
    val acteurFamiliauxSociaux = remember { mutableStateOf(ReseauSection(category = "Acteur familiaux et sociaux",categoryPaint = R.drawable.acteur_familiaux_sociaux, reseauSubSection = emptyList())) }

    acteurFamiliauxSociaux.value.reseauSubSection = listOf(
        ReseauSubSection(
    ...
    Box(
        ...
        Column(
            ...
            Row(
                ...
                if(
                    acteurFamiliauxSociaux.value.reseauSubSection.isNotEmpty()
                    ){
                            ...
                            scope.launch {
                                ...
                                withContext(Dispatchers.IO) {
                                    generatePdf(
                                        context = context,
                                        user = currentUser!!,
                                        listActeursFamiliaux = acteurFamiliauxSociaux.value
                                    )
                                }
