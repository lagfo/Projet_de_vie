...
fun PlanActionScreen(modifier: Modifier = Modifier) {
    ...
    LaunchedEffect(reponse1,reponse2,reponse3,reponse4) {
        PlanificationProjet.projectInfo.planActionReponse1=reponse1
        PlanificationProjet.projectInfo.planActionReponse2=reponse2
        PlanificationProjet.projectInfo.planActionReponse3=reponse3
        PlanificationProjet.projectInfo.planActionReponse4=reponse4
        Log.d("TAG", "PlanActionScreen: ${PlanificationProjet.projectInfo}")
    }
    Box(
